  ...
  return (
    <aside className="sidebar">
      ...
      <ul className="nav-links">
        <li className="sidebar-section-title">Monitor</li>
        ...
        <li className="sidebar-section-title">Protect</li>
        ...
        <Link href={`/${locale}/policies`} passHref legacyBehavior>
          <li className={`nav-item ${isActive("/policies") ? "active" : ""}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
            {navT("policies")}
          </li>
        </Link>

        <li className="sidebar-section-title">{navT("platform")}</li>
        <Link href={`/${locale}/gateways`} passHref legacyBehavior>
          <li className={`nav-item ${isActive("/gateways") ? "active" : ""}`}>
            ...
            {navT("gateways_clusters")}
          </li>
        </Link>
        <Link href={`/${locale}/integrations`} passHref legacyBehavior>
          <li className={`nav-item ${isActive("/integrations") ? "active" : ""}`}>
        ...
        <Link href={`/${locale}/reports`} passHref legacyBehavior>
        ...
        <Link href={`/${locale}/audit`} passHref legacyBehavior>
          <li className={`nav-item ${isActive("/audit") ? "active" : ""}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
            {navT("audit_log")}
          </li>
        </Link>
        <Link href={`/${locale}/settings`} passHref legacyBehavior>
